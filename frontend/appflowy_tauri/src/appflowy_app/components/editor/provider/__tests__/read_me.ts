export default {
  ...
  deltaMap: {
    gCjs671FiD: [],
    G6SPYNOXyd: [{ insert: 'Atalhos de teclado, markdown e bloco de código' }],
    VrW0GWtvmq: [
      { insert: 'Type ' },
    ...
    sZT5qbJvLX: [],
    '6QZZccBfnT': [{ insert: 'Possui alguma dúvida❓' }],
    '5OZNiernqA': [],
    '6okS7LcJz6': [],
    mAce5pJ5iN: [],
    aRUJ8rTJR9: [
    ...
    '3EzeCrtxlh': [],
    '2qonPRrNTO': [{ insert: 'Boas-vindas à Rekreio!' }],
    'b3G76VM-nh': [{ insert: 'Dicas para iniciar' }],
    TTU0eUzM4G: [],
